# SSC CGL Master - Interactive Study Platform & Exam Simulator
...
## ✨ Features
- **Massive Dynamic Notebook:** Covers Math, Reasoning, English, General Awareness, and Computer Knowledge.
- **Subject Filters & Live Search:** Instantly find what you need to study.
- **Visual Learning:** Includes custom SVG graphics for geometry, line graphs, and non-verbal reasoning directly in the notebook.
- **Interactive Exam Simulator:** A replica of the official TCS/Eduquity interface.
- **Practice Mode:** See detailed solutions and "Topper's Shortcuts" immediately after answering a question.
